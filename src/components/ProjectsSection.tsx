...
const projects: Project[] = [
  {
    id: "partner-matching",
    title: "SoulSync — Partner Matching Web Platform",
    year: "2025",
    category: "Full-Stack Web",
    tech: ["MERN Stack", "React 19", "TypeScript", "Redux Toolkit", "RTK Query", "Node.js", "Express.js", "MongoDB", "Socket.IO", "Tailwind CSS", "Framer Motion", "Cloudinary", "JWT Auth", "Zod"],
    description: "Production-quality full-stack compatibility-based partner matching platform powered by a 5-dimensional weighted matching engine, real-time messaging, rich profile management, and an admin moderation dashboard.",
    statBadge: "LIVE DEPLOYED • 5D MATCHING ENGINE • SOCKET.IO",
    gridSpan: "lg:col-span-12",
    githubUrl: "https://github.com/sakibisactive/SoulSync",
    liveUrl: "https://soulsyncbd.vercel.app",
    highlights: [
      "Built a 5-dimensional weighted matching engine: Personality (35% cosine similarity, 50 Likert questions), Interests (25% Jaccard index), Lifestyle (20% weighted matrix), Age Preference (10%), and Location (10% Haversine distance).",
      "Real-time messaging with Socket.IO: typing indicators, online presence, read receipts, and push-like notifications.",
      "Multi-photo upload via Cloudinary + Multer; JWT access/refresh tokens with HTTP-only secure cookies and RBAC (Guest, User, Admin).",
      "Admin dashboard with active user analytics, daily registrations, report queues, user banning, and interest tag management.",
    ],
    architectureDetails: "React 19 + Vite frontend with Redux Toolkit & RTK Query for state/data management. Node.js + Express.js TypeScript backend with MongoDB/Mongoose, Socket.IO real-time engine, Helmet security, rate limiting, and Brevo email integration.",
  },
  {
    id: "connecthub",
    ...
    githubUrl: "https://github.com/sakibisactive/ConnectHub",
  ...
  },
  {
    ...
    statBadge: "LIVE DEPLOYED • MERN STACK + JWT AUTH",
    gridSpan: "lg:col-span-4",
    githubUrl: "https://github.com/sakibisactive/E-commerce",
    liveUrl: "https://e-commerceinbd.vercel.app",
    highlights: [
  ...
  },
  {
    ...
    gridSpan: "lg:col-span-8",
    githubUrl: "https://github.com/sakibisactive/Doctor-Handwriting-Recognition-ML-project",
    highlights: [
  ...
  },
  {
    ...
    gridSpan: "lg:col-span-4",
    githubUrl: "https://github.com/sakibisactive/News-Headline-Text-Classification-NLP-Project",
    highlights: [
